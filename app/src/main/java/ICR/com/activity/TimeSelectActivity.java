...
public class TimeSelectActivity extends BaseActivity {
    //到时候由数据库传入，这里仅作测试用
    private String[][] rs_info = {{"1","财务部会议","老黎","2019-1-1 08:00:00","2019-1-1 08:00:00","2019-1-1 09:00:00","101"},
            {"2","财务部会议","老高","2019-1-1 08:00:00","2019-1-1 09:00:00","2019-1-1 10:00:00","101"},
            {"3","财务部会议","老黎","2019-1-1 08:00:00","2019-1-2 14:00:00","2019-1-2 15:00:00","101"},
            {"4","财务部会议","老黎","2019-1-4 08:00:00","2019-1-1 08:00:00","2019-1-1 09:00:00","102"},
            {"5","财务部会议","老黎","2019-1-5 08:00:00","2019-1-1 09:00:00","2019-1-1 10:00:00","102"},
            {"6","财务部会议","老黎","2019-1-6 08:00:00","2019-1-1 10:00:00","2019-1-1 11:00:00","102"},
            {"7","财务部会议","老黎","2019-1-7 08:00:00","2019-1-1 08:00:00","2019-1-1 09:00:00","103"},
            {"8","财务部会议","老黎","2019-1-1 08:00:00","2019-1-1 08:00:00","2019-1-1 09:00:00","104"},
            {"9","财务部会议","老黎","2019-1-1 08:00:00","2019-1-1 08:00:00","2019-1-1 09:00:00","105"},
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int month = mMonth+1;
        Static_Date = mYear+"-"+month+"-"+mDay; //将获取的系统日期给全局变量Static_Date
    ...
    private DatePickerDialog.OnDateSetListener mdateListener = new DatePickerDialog.OnDateSetListener() {
        ...
        public void onDateSet(DatePicker view, int year, int monthOfYear,
            ...
            Static_Date = mYear+"-"+mMonth+"-"+mDay;//更改选好的日期
