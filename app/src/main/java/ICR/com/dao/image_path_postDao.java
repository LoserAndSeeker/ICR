...
public class image_path_postDao {
    static JSONObject jsoncontainer=new JSONObject();
    public static void registerpost(String imagepath){


        try {
            jsoncontainer.put("tel",userTel);
            jsoncontainer.put("sta_face",imagepath);
    ...
    private static void executeHttpPost() {
        ...
        String path=static_connect+"image_path_post.php";
        try {
