...
public class participate_readDao {
    ...
    private static String[][] executeHttpPost() {
        ...
        String path="http://192.168.43.210/ICR_connect/participate_read.php";
        try {
...
//           con.setRequestProperty("Content-Type", "application/x-www-form-urlencoded");
    ...
    public static String[][] parseJSONWithJSONObject(String jsonData) {
        ...
        try
        {
            ...
            String nam[][]=new String[1][gradeObject.length()];
            for (int i=0; i < gradeObject.length(); i++)    {

                JSONObject jsonObject = gradeObject.getJSONObject(i);


                nam[0][i]=jsonObject.getString("sta_name");//员工姓名
