...
import static ICR.com.activity.BaseActivity.userTel;

public class image_path_readDao {
    static JSONObject jsoncontainer=new JSONObject();
    public static  String[][] participatepost(){
    ...
    private static String[][] executeHttpPost() {
        ...
        String path=static_connect+"image_path_read.php";
        try {
